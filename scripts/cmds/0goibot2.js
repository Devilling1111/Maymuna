...
config: {
 ...
 onStart: async function ({  }) { },
  ...
  if ((event.body.toLowerCase() == "Mim koi") || (event.body.toLowerCase() == "Mim suna") || (event.body.toLowerCase() == "Mim aso")) {
    ...
    if ((event.body.toLowerCase() == "Badol vai") || (event.body.toLowerCase() == "badol vai")) {
     return api.sendMessage("️Boss ekhon BG Ase ok😑", threadID, messageID);
   };
