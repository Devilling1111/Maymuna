...
config: {
 ...
 onStart: async function ({  }) { },
  ...
  if ((event.body.toLowerCase() == "Tomar name ki") || (event.body.toLowerCase() == "নাম কি তোমার")) {
  ...
  if ((event.body.toLowerCase() == "Good morning") || (event.body.toLowerCase() == "Gd M9") || (event.body.toLowerCase() == "good morning")) {
     return api.sendMessage("️Good Morningg!🌄", threadID, messageID);
   };

  if ((event.body.toLowerCase() == "Good night") || (event.body.toLowerCase() == "Gd N8") || (event.body.toLowerCase() == "good night")) {
