...
module.exports = {
	...
	onStart: async function({ api, args, message, event }) {
		...
		const approvedIDsPath = path.join(__dirname, "assist_json", "bypass_id.json");
